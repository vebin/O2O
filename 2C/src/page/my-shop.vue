...
<div class="wraper">
  ...
  <bottomList v-if="storeStatus !== '审核中' && storeStatus !== '已驳回'" :pageInfo="pageInfo" :status="passStatus"></bottomList>
  <a href="/index.html">
    <go-back></go-back>
  </a>
</div>
...
export default {
  components: {StatusTips, Tag, GetAddress, MyStoreStatus, BottomList, GoBack},
  data () {
    return {
      status: 1,
      storeStatus: '',
