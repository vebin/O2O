  ...
  <div class="wraper">
    <div class="upload border-bottom">
      ...
      <figure @click="chooseImage">
        ...
        <img class="addImg" src="https://s.kcimg.cn/wap/images/detail/o2oImg/settled_upload@2x.png" v-if="imgId===''">
        <span class="uploadText" v-if="imgId===''">上传业务照片</span>
      </figure>
    </div>
    <div class="name border-bottom">
      <span class="title">业务名称</span>
      <input type="text" placeholder="如：钣金喷漆、补胎等" class="name-init" @input="oninput" maxlength="20">
...
export default {
  data () {
    return {
      lastScrollHeight: 24,
      bgImg: 'https://s.kcimg.cn/wap/images/detail/o2oImg/main-business.jpg',
      name: '如：钣金喷漆、补胎等',
      nameInit: '如：钣金喷漆、补胎等',
      price: '',
      lock: true,
